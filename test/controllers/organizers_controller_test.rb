...
class OrganizersControllerTest < ActionController::TestCase
  ...
  test "should create organizer" do
    assert_difference('Organizer.count') do
      post :create, organizer: { address: @organizer.address, email: @organizer.email, phone: @organizer.phone, title: @organizer.title }
    end
  ...
  test "should update organizer" do
    patch :update, id: @organizer, organizer: { address: @organizer.address, email: @organizer.email, phone: @organizer.phone, title: @organizer.title }
    assert_redirected_to organizer_path(assigns(:organizer))
  end
