...
class AlternativesControllerTest < ActionController::TestCase
  ...
  test "should create alternative" do
    assert_difference('Alternative.count') do
      post :create, alternative: { question_id: @alternative.question_id, title: @alternative.title, veracity: @alternative.veracity }
    end
  ...
  test "should update alternative" do
    patch :update, id: @alternative, alternative: { question_id: @alternative.question_id, title: @alternative.title, veracity: @alternative.veracity }
    assert_redirected_to alternative_path(assigns(:alternative))
  end
